(function ($) {
  "use strict";
	...
	swiperslider.each(function () {  
				...
				var autoplay_obj = false;
				if (autoplay2 === true || autoplay2 === 'true') {
					var delay_val = (autoplayspeed1 && !isNaN(autoplayspeed1)) ? parseInt(autoplayspeed1) : 5000;
					autoplay_obj = {
						delay: delay_val,
